...
export function KanbanBoard({ tasks, productId, onCreateTask }: KanbanBoardProps) {
  ...
  const [selectedStage, setSelectedStage] = useState<TaskStage>('TODO' as TaskStage);
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="bg-zinc-800 border-zinc-700 text-white">
          ...
          <div className="space-y-3">
            ...
            <select
              value={selectedStage}
              onChange={(e) => setSelectedStage(e.target.value as TaskStage)}
